...
resource "matchbox_group" "coreos_livecd_controller" {
  count   = "${length(var.tectonic_metal_controller_names)}"
  name    = "${format("coreos-livecd-controller-%s", element(var.tectonic_metal_controller_names, count.index))}"
  profile = "${matchbox_profile.coreos_livecd_controller.name}"
...
resource "matchbox_group" "coreos_livecd_worker" {
  count   = "${length(var.tectonic_metal_worker_names)}"
  name    = "${format("coreos-livecd-worker-%s", element(var.tectonic_metal_worker_names, count.index))}"
  profile = "${matchbox_profile.coreos_livecd_worker.name}"
